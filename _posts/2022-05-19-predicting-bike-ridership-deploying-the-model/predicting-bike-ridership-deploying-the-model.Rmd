...
Assuming I haven't shut it down (or my billing information is out of date), you can [try the app here](https://hfx-bike-ridership-app-74govvz7xq-uc.a.run.app/) or embedded below:
...
There is a lot of data involved in the full project, but I decided to keep this app fairly small in scope.
