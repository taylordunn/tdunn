...
run_monad_instruction <- function(vars, instr) {
  ...
  switch(instr$operation,
    ...
    "div" = {
      stopifnot(var2 != 0)
      vars[[instr$var1]] <- floor(vars[[instr$var1]] / var2)
    },
    "mod" = {
...
So I can write a simple function which takes the input `w`, divides `z`

```{r}
function(input_w, step5 = 1, step6 = 10, step16 = 10) {
  # Step 2
  x <- 0
  # Step 3
  x <- z
