...
Calculate the $y$ trajectory for this initial velocity, use `cumsum`:
...
the cumulative sum of a sequence of integers is a triangular number with the value:
...
vxy_candidates %>%
  ...
  summarise(steps = str_c(step, collapse = ", "))
```
