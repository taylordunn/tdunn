...
description: |
  My solutions to the #AdventOfCode 2021 coding challenges.
author:
  - name: Taylor Dunn
date: 2021-12-01
params:
...
To keep me motivated, I'll also be "competing" in a private leaderboard started by [Tan Ho](https://twitter.com/_TanHo/status/1465310512716173313).
...
For the Python solution, I will make sure of the `numpy.diff` function to calculate the difference between consecutive values:
