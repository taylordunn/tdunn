...
```{r}
day3 <- read_lines(here("_posts", "2021-12-01-advent-of-code-2021",
                        "day03-input.txt"))
head(day3)
```
...
```{r}
day4 <- read_lines(here("_posts", "2021-12-01-advent-of-code-2021",
                        "day04-input.txt"))
head(day4, 8)
```
...
called_numbers; bingo_boards[1]
```

Now I need to convert the called numbers to a numeric vector, and the bingo boards to numeric matrices:
