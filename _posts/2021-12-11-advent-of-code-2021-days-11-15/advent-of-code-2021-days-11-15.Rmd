...
By doing the replacements in this way, pairs I avoid accidentally finding new pairs during a single step.
...
for step in range(10):
  ...
  for i, (pair, placeholder) in enumerate(zip(step_pairs, placeholders)):
    while pair in polymer_template_part1:
      #print(i, pair, polymer_template_part1)
  ...
  for i, (insertion, placeholder) in enumerate(zip(step_insertions, placeholders)):
    while placeholder in polymer_template_part1:
      #print(i, step_insertions[i], polymer_template_part1)
      polymer_template_part1 = polymer_template_part1.replace(
...
The polymer from part 1 consists of `r nchar(polymer_template_part1)` elements, and will continue to exponentially grow too large to store in memory before reaching 40 steps.
