...
tibble::tribble(
  ...
  1, 10, "11:11:48", 34029, 0,
  2, 10, "11:25:31", 32045, 0
) %>%
  select(-Score) %>%
...
leaderboard %>%
  write_rds(here("_posts", "2021-12-11-advent-of-code-2021-days-11-15",
                 "leaderboard_2021-12-15.rds"))

```

```{r echo=FALSE}
leaderboard <-
  read_rds(here("_posts", "2021-12-11-advent-of-code-2021-days-11-15",
                "leaderboard_2021-12-15.rds"))
```
