...
weather_data %>%
  ...
  geom_smooth(data = . %>% filter(speed_max_gust > 20), method = "loess") +
...
From this visual, I would say that the 7- and 14-day lags are just as well-correlated as the 1-, 2-, and 3-day lags.
