...
I would prefer to use negative binomial regression instead of Poisson to account for overdispersion, but [this model hasn't been implemented in `parsnip` yet](https://github.com/tidymodels/parsnip/issues/35#issuecomment-1001088658).
