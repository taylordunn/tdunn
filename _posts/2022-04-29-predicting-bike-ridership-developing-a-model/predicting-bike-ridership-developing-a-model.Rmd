...
It's a shame to not have more data to test a full year -- most of the test set covers winter and spring.
...
In the end, the XGBoost models were able to predict bike ridership the best in this data set.
In my next post, I'll "productionalize" the model to serve predictions.
