...
Compute and plot the pairwise correlations with `GGally`:
...
For the most frequent countries, show the distribution of ratings:
...
Ethopia coffee has a very clear lead in terms of ratings, while Colombia has very consistently high ratings.
...
These have different meanings (e.g. an `NA` value could be a common variety but is just missing) but I will combine both:
