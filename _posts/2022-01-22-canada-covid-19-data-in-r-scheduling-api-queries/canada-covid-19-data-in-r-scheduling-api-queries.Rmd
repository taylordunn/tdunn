...
*Update 2022-02-07*: since writing this post, I've put this data pipeline to use with a Shiny dashboard reporting the latest Canadian Covid-19 numbers.
...
See the [data chapter](https://r-pkgs.org/data.html#data) of the [R Packages](https://r-pkgs.org/) book for more information.
...
^[Note that I don't need to provide my personal access `token` argument to register the board, because it is automatically retrieved from `gitcreds`.]
